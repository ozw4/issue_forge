...
- batch helper fixtures restore check/review rounds and cumulative fix budgets from history, reuse clean accepted reviews, re-evaluate dirty interrupted fixes, reconcile existing PRs before creation, atomically persist batch head/PR metadata, and skip duplicate auto-merge requests for merged PRs
