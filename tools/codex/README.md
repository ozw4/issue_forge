...
- queue resume fixtures cover terminal no-op, interrupted dirty implementation, committed-Issue skip, batch checks, publish reconciliation and existing-PR lookup, open and already-merged auto-merge reconciliation through ack, stale/live locks, dirty wrong-branch rejection, and missing/old plan or state rejection
